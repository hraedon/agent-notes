#!/usr/bin/env python3
"""Install agent-notes' dev/test environment against the LOCKED suite substrate.
...
import suite_lock  # noqa: E402  (local helper, resolved via the sys.path insert above)
