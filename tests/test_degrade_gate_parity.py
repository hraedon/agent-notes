...
class TestGateAttestation:
    def test_attest_records_diagnostic_key(self, default_project, monkeypatch):
        ...
        out = WorkItemModel.attest_gate_waiver(
            default_project.id,
            "DG-ATT-01",
            reason="retroactive review by operator",
        )
